...
var lexicalDictionary = []lexicalPair{
	...
	{regex: `^\+=`, handler: lexemeHandler(token.A_PLUS, 0, none)},
	{regex: `^\+`, handler: lexemeHandler(token.PLUS, 0, none)},
	{regex: `^-=`, handler: lexemeHandler(token.A_MINUS, 0, none)},
	{regex: `^-`, handler: lexemeHandler(token.MINUS, 0, none)},
	{regex: `^\*\*=`, handler: lexemeHandler(token.A_EXP, 0, none)},
	{regex: `^\*\*`, handler: lexemeHandler(token.EXP, 0, none)},
	{regex: `^\*=`, handler: lexemeHandler(token.A_STAR, 0, none)},
	{regex: `^\*`, handler: lexemeHandler(token.STAR, 0, none)},
	{regex: `^\/\/=`, handler: lexemeHandler(token.A_F_DIV, 0, none)},
	{regex: `^\/\/`, handler: lexemeHandler(token.F_DIV, 0, none)},
	{regex: `^\/=`, handler: lexemeHandler(token.A_SLASH, 0, none)},
	...
	{regex: `^\|\|=`, handler: lexemeHandler(token.A_OR, 0, none)},
	{regex: `^\|\|`, handler: lexemeHandler(token.OR, 0, none)},
	{regex: `^&&=`, handler: lexemeHandler(token.A_AND, 0, none)},
	{regex: `^&&`, handler: lexemeHandler(token.AND, 0, none)},
	{regex: `^\|=`, handler: lexemeHandler(token.A_B_OR, 0, none)},
	{regex: `^\|`, handler: lexemeHandler(token.B_OR, 0, none)},
	{regex: `^&=`, handler: lexemeHandler(token.A_B_AND, 0, none)},
	...
	{regex: `^\?=`, handler: lexemeHandler(token.A_Q_MARK, 0, none)},
