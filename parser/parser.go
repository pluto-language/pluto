...
func New(text string) *Parser {
	...
	p.infixes = map[token.Type]infixParser{
		...
		token.A_AND:    p.parseInfix,
		token.A_B_AND:  p.parseInfix,
		token.A_B_OR:   p.parseInfix,
		token.A_EXP:    p.parseInfix,
		token.A_F_DIV:  p.parseInfix,
		token.A_MINUS:  p.parseInfix,
		token.A_MOD:    p.parseInfix,
		token.A_OR:     p.parseInfix,
		token.A_PLUS:   p.parseInfix,
		token.A_Q_MARK: p.parseInfix,
		token.A_SLASH:  p.parseInfix,
		token.A_STAR:   p.parseInfix,
